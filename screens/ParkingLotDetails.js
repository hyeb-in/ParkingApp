  ...
  return (
    <View style={styles.container}>       
      <Text style={styles.title} >
        <Image source={require('../assets/car.png')} style={{width: 30, height: 30, }} /> {result.prkplceNm}
        <Text style={[styles.small, { marginLeft: 50 }]}> {result.prkplceSe}</Text>
        <CheckFavorite style={styles.star} parkingLotId={parkingLotId}/> {/* 즐겨찾기 별 버튼 */}
      </Text>
